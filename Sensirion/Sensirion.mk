...
GLOBAL_INCLUDES := . \
                    ...
                    $(SDK_ROOT)/sys \
                    $(PROJ_DIR)/acnsdkc \
                    $(PROJ_DIR)/sensirion_ess/sensirion_ess \
                    $(PROJ_DIR)/sensirion_ess/sensirion_common \
                    $(PROJ_DIR)/sensirion_ess/SGP30 \
                    $(PROJ_DIR)/sensirion_ess/SHTC1 \
                    $(SDK_ROOT)/src/wolfSSL \
                    $(SDK_ROOT)/src/wolfSSL/wolfssl\

$(NAME)_SOURCES	:= $(PROJ_DIR)/Sensirion.c \
                   ...
                   $(PROJ_DIR)/sensirion_ess/SGP30/sgp30.c \
                   $(PROJ_DIR)/sensirion_ess/SGP30/sgp30_featureset.c \
                   $(PROJ_DIR)/sensirion_ess/SHTC1/shtc1.c \
                   $(PROJ_DIR)/sensirion_ess/SHTC1/sht_common.c \
                   $(PROJ_DIR)/sensirion_ess/sensirion_ess/sensirion_ess.c \
                   $(PROJ_DIR)/sensirion_ess/sensirion_ess/ess_device_configs.c \
                   $(PROJ_DIR)/sensirion_ess/sensirion_common/sensirion_common.c \
                   $(PROJ_DIR)/sensirion_ess/sensirion_common/sensirion_configuration.c \
