...
/* gateway */
#define GATEWAY_UID_PREFIX          "ESS"
#define GATEWAY_NAME                "SensirionESSGateway"
#define GATEWAY_OS                  "WICED_RTOS"

/* gateway firmware */
#define GATEWAY_SOFTWARE_NAME       "SensirionEval"
#define GATEWAY_SOFTWARE_VERSION    "1.0.0"

/* device */
#define DEVICE_NAME                 "SensirionESSDevice"
#define DEVICE_TYPE                 "SensirionESS"
#define DEVICE_UID_PREFIX           "ESS-device"
